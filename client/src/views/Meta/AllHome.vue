<template lang="">
  <div class="main-content flex flex-col flex-grow p-4">
    <h1 class="font-bold text-2xl text-gray-700 no-underline">
      HomePage Meta List
    </h1>
        ...
        <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
          ...
          >
            <router-link
              to="/add-home-meta"
              type="button"
              class="middle none center m-2 rounded-lg bg-green-700 py-3 px-6 font-sans text-xs font-bold uppercase text-white shadow-md shadow-green-500/20 transition-all hover:shadow-lg hover:shadow-green-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
            ...
            <table class="min-w-full leading-normal">
              ...
              <tbody>
                <tr v-for="user in users" :key="user.id">
                  ...
                  >
                    <!-- <button
                      class="middle none center m-2 rounded-lg bg-blue-500 py-3 px-6 font-sans text-xs font-bold uppercase text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                      data-ripple-light="true"
                    >
                      Edit
                    </button> -->
